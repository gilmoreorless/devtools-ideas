/**
 * css-parse node module: https://github.com/visionmedia/css-parse
 *
 * Copied and tweaked to be a global function without going through Browserify.
 * For testing purposes only.
 */
CSSParse = function(css, options){
  options = options || {};
