...
//
//  Modified by Gilmore Davidson to remove MooTools dependency for modern browsers
//
...
Tangle.classes.TKAdjustableNumber = {
    ...
    updateStyle: function () {
        if (this.isDragging) { this.element.classList.add("TKAdjustableNumberDown"); }
        else { this.element.classList.remove("TKAdjustableNumberDown"); }

        if (!this.isDragging && this.isActive()) { this.element.classList.add("TKAdjustableNumberHover"); }
        else { this.element.classList.remove("TKAdjustableNumberHover"); }
    },
